...
export default function Cart({ items, onRemove, onClose, onUpdateQty }) {
  ...
  // Bug 6 I have change this use item.qty to correctly compute the total
                  ...
                  <div className="cart-item-info">
                    ...
                    <div className="cart-item-controls">
                      <button
                        ...
                        //  Bug 7 (ORIGINAL — allows qty to drop to 0 breaking the total)
                        // disabled={item.qty <= 0}

                        // Bug 7  I have change this disable at 1 so qty can never go below 1
                        disabled={item.qty <= 1}
                      >−</button>
